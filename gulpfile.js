...
gulp.task('default', gulp.parallel('img', 'favicon', 'fonts', 'styles', 'scripts', 'html', 'browser-sync', 'watch'));
...
gulp.task('default', gulp.parallel( 'favicon', 'fonts', 'styles', 'scripts', 'html', 'browser-sync', 'watch'));
 */
